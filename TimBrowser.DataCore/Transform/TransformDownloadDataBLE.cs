...
{
    public enum TranformErrorCodesBLE
    {
        NoErr = 0,
        GetDeviceInfoErr = 10
    }

    public class TransformDownloadDataBLE
    {
        public TransformDownloadDataBLE()
        {
        ...
        public InformationModuleData Transform(FuncDownloadDataBLE funcDownloadData)
        {
        ...
        private TableItem FillParametersTable(FuncDownloadDataBLE funcDownloadData, TableItem parametersTemplate)
        {
        ...
        private DeviceInfo GetDeviceInfo(FuncDownloadDataBLE funcDownloadData, TableItem paramTable)
        {
        ...
        private List<DeviceLogInfo> GetDeviceLogsInfo(FuncDownloadDataBLE funcDownloadData, DeviceInfo deviceInfo)
        {
        ...
        private List<LogEventRecordItem> GetLogEvents(FuncDownloadDataBLE funcDownloadData, 
        ...
        private List<LogEventAndCmdRecordItem> GetLogEventsAndCmd(FuncDownloadDataBLE funcDownloadData,
        ...
        private List<LogCmdRecordItem> GetLogCommands(FuncDownloadDataBLE funcDownloadData,
            List<DeviceLogInfo> deviceLogsInfo, TableItem paramTable)
        {
        ...
        private List<LogParamRecordItem> GetLogParam(FuncDownloadDataBLE funcDownloadData, List<DeviceLogInfo> deviceLogsInfo,
        ...
        private List<LogSimRecordItem> GetLogSim(FuncDownloadDataBLE  funcDownloadData, List<DeviceLogInfo> deviceLogsInfo,
            TableItem paramTable)
        {
