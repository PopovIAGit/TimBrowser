...
namespace TimBrowser.Services.Print
{
    public class PimpedPaginator : DocumentPaginator
    {
        ...
        public override DocumentPage GetPage(int pageNumber)
        {
            ...
            DrawingVisual pageNum = new DrawingVisual();

            // Номер страницы
            using (DrawingContext ctx = pageNum.RenderOpen())
            {
                if (typeface == null)
                {
        ...
        public class Definition
        {
            ...
            public Definition(int startPageNum_)
            {
                StartPageNum = startPageNum_;
            }
            ...
            private Thickness _Margins = new Thickness(96 / 3); // Default: 1" margins
