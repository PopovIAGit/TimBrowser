...
{
    public class LogEvParametersViewModel : Screen
    {

        public LogEvParametersViewModel(TimLogEvRecItem logEvRec)
        {
            if (logEvRec != null)
            {
                ...
                ParameterFilterList = Helper.ViewModelUtils
                    .CreateParameterSortItem(_logParameters, OnSortParamCheckedChanged);
        ...
        private List<ParameterSortItem> _parameterFilterList;
        private bool _ignoreCheckedChanged;
        
        #endregion

        // обработка изменения состояния CheckBox'ов, т.е. сортировка таблицы параметров
        private void OnSortParamCheckedChanged(ParameterSortItem sortItem)
        {
        ...
        public List<ParameterSortItem> ParameterFilterList
        {
    ...
    public class ParameterSortItem : PropertyChangedBase
    {
        public ParameterSortItem(bool isChecked, string name, string index, 
        ...
        private System.Action<ParameterSortItem> _checkedChangedAction;
